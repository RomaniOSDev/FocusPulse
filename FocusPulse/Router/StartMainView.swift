...
struct NewLoadTwoCircleView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            // Трек с объёмом (градиент: сверху светлее, снизу темнее)
            Circle()
                .stroke(
                    AngularGradient(
                        colors: [
            ...
            // Белые сегменты с объёмом и свечением
...
struct EndLoadingIndicator: View {
    private let greenColor = Color.green // или Color("greenApp"), если добавите в Assets
